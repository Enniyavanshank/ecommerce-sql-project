...
## 📌 Overview
This project focuses on analyzing an e-commerce dataset using Microsoft SQL Server.  
It demonstrates how SQL can be used to extract meaningful business insights from structured data.
